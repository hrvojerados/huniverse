...
<div style="display:flex; gap:1rem; justify-content:center; align-items:center;">
  <figure style="flex:1; margin:0;">
    <img src="../assets/post_1/popularitacije.jpg" alt="Popularitacije" loading="lazy" style="width:100%;">
    <figcaption style="text-align:center; font-size:0.9rem">My friend Adian and I holding a workshop about statistics</figcaption>
  </figure>

  <figure style="flex:1; margin:0;">
    <img src="../assets/post_1/marinada.jpg" alt="Marinada" loading="lazy" style="width:100%;">
...
<div style="display:flex; gap:1rem; justify-content:center; align-items:center;">
  <figure style="flex:1; margin:0;">
    <img src="../assets/post_1/zimska.jpg" alt="zimska" loading="lazy" style="width:100%;">
...
<div style="display:flex; gap:1rem; justify-content:center; align-items:center;">
  <figure style="flex:1; margin:0;">
    <img src="../assets/post_1/eksperimentStoljeca.jpg" alt="Popularitacije" loading="lazy" style="width:100%;">
    <figcaption style="text-align:center; font-size:0.9rem">Pushing the limits of what's possible...</figcaption>
  </figure>

  <figure style="flex:1; margin:0;">
    <img src="../assets/post_1/sah.jpg" alt="Marinada" loading="lazy" style="width:100%;">
    <figcaption style="text-align:center; font-size:0.9rem">Was a tough and fair match.</figcaption>
  </figure>
</div>
<div>
  <figure style="flex:1; margin:0;">
    <img src="../assets/post_1/palacinke.jpg" alt="Marinada" loading="lazy" style="width:100%;">
...
<div>
  <figure style="flex:1; margin:0;">
    <img src="../assets/post_1/pleternica.jpg" alt="Marinada" loading="lazy" style="width:100%;">
    <figcaption style="text-align:center; font-size:0.9rem">Vineyard near Pleternica</figcaption>
  </figure>
</div>
<div>
  <figure style="flex:1; margin:0;">
    <img src="../assets/post_1/papuk.webp" alt="Marinada" loading="lazy" style="width:100%;">
...
<div style="display:flex; gap:1rem; flex-direction:column; justify-content:center; align-items:center;">
  <figure style="flex:1; margin:0; display:flex; justify-content: space-evenly">
    <img src="../assets/post_1/benjamin.jpeg" alt="Popularitacije" loading="lazy" style="width:50%;">
    <img src="../assets/post_1/erik.jpeg" alt="Marinada" loading="lazy" style="width:50%;">
  </figure>
